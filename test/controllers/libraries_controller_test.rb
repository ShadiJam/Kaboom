...
class LibrariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create library" do
    assert_difference('Library.count') do
      post libraries_url, params: { library: { city: @library.city, country: @library.country, name: @library.name, not_interested: @library.not_interested, url: @library.url } }
    end
  ...
  test "should update library" do
    patch library_url(@library), params: { library: { city: @library.city, country: @library.country, name: @library.name, not_interested: @library.not_interested, url: @library.url } }
